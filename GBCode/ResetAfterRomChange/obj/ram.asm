...
00117$:
	...
	or	a, c
	jr	Z, 00117$
;./C/romreset.c:25: while((STAT_REG & 0b11) != 1);
00120$:
	ldh	a, (_STAT_REG+0)
	and	a, #0x03
	ld	b, a
	...
	or	a, c
	jr	NZ, 00120$
;./C/romreset.c:27: my_cpu = cpu;
	ldhl	sp,	#3
	ld	a, (hl)
	ld	(#_my_cpu),a
;./C/romreset.c:28: reset_gameboy();
;./C/romreset.c:30: }
	jp  _reset_gameboy
;./C/romreset.c:32: void reset_gameboy() __naked {
;	---------------------------------
; Function reset_gameboy
; ---------------------------------
_reset_gameboy::
;./C/romreset.c:36: __endasm;
	ld	a,(_my_cpu)
	jp	0x100
;./C/romreset.c:37: }
	.area _RAMCODE
